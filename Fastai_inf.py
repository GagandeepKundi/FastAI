...
inf_learn = load_learner('/Users/brl.314/Downloads/Fastapi/India_Spam_Fastai/Inference/Train_Aug2.pkl')
...
async def predict_spam(content: str):
    ...
    if predict=='0' and probability>0.97: #0.97 is the threshold
        return {"Prediction":True,"Probability": probability}
    else:
        return {"Prediction":False,"Probability": 1-probability}
